...
```{r 8h, echo=FALSE, out.width='95%', fig.align='center', fig.cap='Resultado de la encriptación.'}
...
11. Ahora quedan tareas que ya conocemos (salvo una que veremos después): 
    i. vamos a asignar un sistema de archivos a ese volumen encriptado (que no al “newvar” a secas) con el comando `mkfs –t ext4 /dev/mapper/pmraid1-newvar_crypt`; 
    ii. ahora lo montamos en un directorio auxiliar de `/mnt`, por ejemplo `/mnt/varcifr`, y le copiamos todos los archivos. Veamos estas operaciones ejecutadas (ver figura \@ref(fig:10h)):
